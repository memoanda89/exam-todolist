...
const reducer = (state = initialState, { type, payload }: IAppActionCreator) => {
  switch (type) {
    ...
    case IAppActionTypes.ADDRANDOMTASK:{
      return state;
    }
    case IAppActionTypes.ADDTASK:{
      return state;
    }
    case IAppActionTypes.UPDATETASK:{
      return state;
    }
    case IAppActionTypes.DELETETASK:{
      return state;
    }
    case IAppActionTypes.DELETETASKS:{
      return state;
    }
